...
**이번 주 1-2시간 (mid)**: Claude Code와 Cursor 3의 Background Agent를 동일한 ERP 태스크(예: "상품 테이블에 재고 알림 로직 추가")에 각각 투입해 결과물 품질·소요 시간·문맥 이해도를 비교 측정. 어느 쪽 에이전트가 와당탕연구소 스타일의 단일 레포 풀스택 구조를 더 잘 파악하는지 데이터 남기기.
...
- [Cursor 성장 스토리 심층 분석 — Fortune (2026.03)](https://fortune.com/2026/03/21/cursor-ceo-michael-truell-ai-coding-claude-anthropic-venture-capital/)
- [Background Agents 가이드](https://docs.cursor.com/en/background-agent)
